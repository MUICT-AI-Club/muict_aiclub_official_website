...
function buildSocialLinks(member) {
  ...
  if (member.linkedin) {
    links.push(`<a href="${member.linkedin}" target="_blank" rel="noopener" class="social-link" title="LinkedIn">
  ...
  if (member.github) {
    links.push(`<a href="${member.github}" target="_blank" rel="noopener" class="social-link" title="GitHub">
      <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
